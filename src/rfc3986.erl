...
-export(['IP-literal'/0, 'IPv4address'/0,
	 'IPv6address'/0, 'IPvFuture'/0, 'URI'/0,
	 'URI-reference'/0, 'absolute-URI'/0, authority/0,
	 'dec-octet'/0, decode/2, fragment/0, 'gen-delims'/0,
	 h16/0, 'hier-part'/0, host/0, ls32/0, path/0,
	 'path-abempty'/0, 'path-absolute'/0, 'path-empty'/0,
	 'path-noscheme'/0, 'path-rootless'/0, pchar/0,
	 'pct-encoded'/0, port/0, query/0, 'reg-name'/0,
	 'relative-part'/0, 'relative-ref'/0, reserved/0,
	 scheme/0, segment/0, 'segment-nz'/0, 'segment-nz-nc'/0,
	 'sub-delims'/0, unreserved/0, userinfo/0]).
